...
-(NSString *)WorkOutSubsriptionInDays:(NSString*)theProductID{
    ...
    if ([[theProductID lowercaseString] isEqualToString:@"physicsiphone1month"] ){
        
        return @"31";
        
    }
    
    else if ([[theProductID lowercaseString] isEqualToString:@"physicsiphonemonths"] ){ // Type at apple I did not add 3 to the string
...
-(void)SendToLearnersCloud{
    ...
    VerificationAppID = [[NSString alloc] initWithString:@"8"]; //Physics iPhone
